        ...
        <div>
            ...
            <main className='max-w-6xl mx-auto p-10 border'>
                ...
                <p className='pb-5 pt-2'>
                    By adding an item to the marketplace, you're essentiaally Minting an NFT of the item into your wallet which we can then list for sale!
                </p>
                <div className='flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-10'>
                    ...
                    <form onSubmit={mintNFT} className='flex flex-col flex-1 p-2 space-y-2 justify-center'>
                        ...
                        <input name='name' id='name' className='formfield' placeholder='Name of Item...' type="text" />
                        <label className='font-light'>Description</label>
                        <input name='description' id='description' className='formfield' placeholder='Enter Description...' type="
                        text" />
